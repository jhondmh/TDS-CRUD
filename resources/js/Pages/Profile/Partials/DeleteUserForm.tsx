...
export default function DeleteUserForm() {
    const route = useRoute();
    const [confirmingUserDeletion, setConfirmingUserDeletion] = useState(false);
    const form = useForm(); // Eliminar la referencia a la contraseña
    ...
    return (
        ...
        >
            <div className="max-w-xl text-sm text-gray-600 dark:text-gray-400">
                Una vez eliminada su cuenta, todos sus recursos y datos serán eliminados de forma permanente. Antes de eliminar su cuenta, por favor descargue cualquier dato o información que desee conservar.
            </div>
            ...
            >
                <div className='px-6'>
                    ¿Está seguro de que desea eliminar su cuenta? Una vez eliminada su cuenta, todos sus recursos y datos se borrarán permanentemente.
                </div>
                <div className="mt-6 px-6 flex justify-end">
                    <SecondaryButton onClick={closeModal}>
                        Cancelar
