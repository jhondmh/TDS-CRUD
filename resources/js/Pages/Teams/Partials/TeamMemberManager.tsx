					...
					>
						...
						{availableRoles.length > 0 ? (
							<div className="col-span-6 lg:col-span-4">
								...
								<div className="relative z-0 mt-1 border-transparent border-gray-200 dark:border-gray-700 rounded-lg cursor-pointer">
									{availableRoles.map((role, i) => (
										<button
											type="button"
											className={classNames(
												'dark:bg-gray-900 border-transparent relative px-4 py-3 inline-flex w-full rounded-lg',
												{
													'border-transparent    rounded-t-none':
														i > 0,
													'rounded-b-none':
														i !=
														Object.keys(
